...
const Button = ({ text, onClick }) => (
  <div className="w-full flex justify-center mt-5">
    <button
      ...
      onClick={onClick}
    >
      <span className="box-border relative w-fit mt-[-1.00px] font-single-line-body-base font-[number:var(--single-line-body-base-font-weight)] text-color-text-brand-on-brand text-[length:var(--single-line-body-base-font-size)] tracking-[var(--single-line-body-base-letter-spacing)] leading-[var(--single-line-body-base-line-height)] whitespace-nowrap [font-style:var(--single-line-body-base-font-style)]">
        {text}
      </span>
    </button>
  </div>
