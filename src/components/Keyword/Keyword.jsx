...
const Keyword = ({ keyword, isSelected, onSelectKeyword }) => (
  <div 
    className={`flex w-24 h-[35px] items-center justify-center gap-2.5 px-4 py-px relative ${isSelected ? `bg-blue-200` : `bg-[#fffafa]`} rounded-[10px] cursor-pointer pointerhover:hover:bg-blue-300`}
